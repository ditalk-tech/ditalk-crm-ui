...
export const isEmptyStr = (val: any): boolean =>
  isNullOrUndefined(val) || (typeof val === 'string' && val.trim() === '');

export const hasText = (val: any): val is string =>
  typeof val === 'string' && val.trim().length > 0;

export const isEmptyArr = (val: any): boolean =>
  isNullOrUndefined(val) || !Array.isArray(val) || val.length === 0;

export const hasItems = (val: any): val is any[] =>
...
export const isEmptyValue = (val: any): boolean =>
  isEmptyStr(val) || isEmptyArr(val) || isEmptyObj(val) || isNullOrUndefined(val);
